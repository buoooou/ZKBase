package kafeihu.zk.base.util.reflect;//package kafeihu.zk.base.util.reflect;
//
...
//    {
//
//        Instance<String> ibStr = new Instance<String>();
...
//        params[1] = param1;
//        Instance<Socket> ibSock = new Instance<Socket>();
